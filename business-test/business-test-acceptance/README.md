# Cucumber Retrieve Targets acceptance test
...
This runs Cucumber features using Cucumber's JUnit runner. The `@RunWith(Cucumber.class)` annotation on the `retrieve.RunCukesTest`
